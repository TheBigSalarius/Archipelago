...
def set_rules(world: MultiWorld, player: int):
    ...
    if world.consumable_count[player].value >= 1:
        set_rule(world.get_location("Consumable Check 1", player), lambda state: state._riftwizard_mana(player, int(1 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 2:
        set_rule(world.get_location("Consumable Check 2", player), lambda state: state._riftwizard_mana(player, int(2 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 3:
        set_rule(world.get_location("Consumable Check 3", player), lambda state: state._riftwizard_mana(player, int(3 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 4:
        set_rule(world.get_location("Consumable Check 4", player), lambda state: state._riftwizard_mana(player, int(4 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 5:
        set_rule(world.get_location("Consumable Check 5", player), lambda state: state._riftwizard_mana(player, int(5 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 6:
        set_rule(world.get_location("Consumable Check 6", player), lambda state: state._riftwizard_mana(player, int(6 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 7:
        set_rule(world.get_location("Consumable Check 7", player), lambda state: state._riftwizard_mana(player, int(7 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 8:
        set_rule(world.get_location("Consumable Check 8", player), lambda state: state._riftwizard_mana(player, int(8 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 9:
        set_rule(world.get_location("Consumable Check 9", player), lambda state: state._riftwizard_mana(player, int(9 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 10:
        set_rule(world.get_location("Consumable Check 10", player), lambda state: state._riftwizard_mana(player, int(10 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 11:
        set_rule(world.get_location("Consumable Check 11", player), lambda state: state._riftwizard_mana(player, int(11 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 12:
        set_rule(world.get_location("Consumable Check 12", player), lambda state: state._riftwizard_mana(player, int(12 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 13:
        set_rule(world.get_location("Consumable Check 13", player), lambda state: state._riftwizard_mana(player, int(13 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 14:
        set_rule(world.get_location("Consumable Check 14", player), lambda state: state._riftwizard_mana(player, int(14 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 15:
        set_rule(world.get_location("Consumable Check 15", player), lambda state: state._riftwizard_mana(player, int(15 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 16:
        set_rule(world.get_location("Consumable Check 16", player), lambda state: state._riftwizard_mana(player, int(16 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 17:
        set_rule(world.get_location("Consumable Check 17", player), lambda state: state._riftwizard_mana(player, int(17 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 18:
        set_rule(world.get_location("Consumable Check 18", player), lambda state: state._riftwizard_mana(player, int(18 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 19:
        set_rule(world.get_location("Consumable Check 19", player), lambda state: state._riftwizard_mana(player, int(19 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 20:
        set_rule(world.get_location("Consumable Check 20", player), lambda state: state._riftwizard_mana(player, int(20 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 21:
        set_rule(world.get_location("Consumable Check 21", player), lambda state: state._riftwizard_mana(player, int(21 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 22:
        set_rule(world.get_location("Consumable Check 22", player), lambda state: state._riftwizard_mana(player, int(22 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 23:
        set_rule(world.get_location("Consumable Check 23", player), lambda state: state._riftwizard_mana(player, int(23 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 24:
        set_rule(world.get_location("Consumable Check 24", player), lambda state: state._riftwizard_mana(player, int(24 * floors / world.consumable_count[player].value * 3 - 3)))

    if world.consumable_count[player].value >= 25:
        set_rule(world.get_location("Consumable Check 25", player), lambda state: state._riftwizard_mana(player, int(25 * floors / world.consumable_count[player].value * 3 - 3)))
    ...
    if world.goal[player] == 1:
        set_rule(world.get_location("Mordred", player),
                 lambda state: state._riftwizard_mana(player, world.floor_goal[player].value*3-6))
    if world.goal[player] == 0:
