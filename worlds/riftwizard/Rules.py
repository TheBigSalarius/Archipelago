...
def set_rules(world: MultiWorld, player: int):
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 3 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 4 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 5 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 6 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 7 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 8 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 9 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 10 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 11 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 12 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 13 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 14 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 15 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 16 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 17 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 18 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 19 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 20 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 21 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 22 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 23 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 24 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 25 or world.end_goal[player] == 0:
    ...
    if world.end_goal[player] == 1 and world.floor_goal[player].value >= 26 or world.end_goal[player] == 0:
